...
//  AngryBirdClone
//
//  Created by Dilara Akdeniz on 1.05.2023.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        self.physicsBody = SKPhysicsBody(edgeLoopFrom: frame) //Telefonun etrafina cerceve yaptik boylece kus dusunce sonsuza gitmedi.
        self.scene?.scaleMode = .aspectFit
        self.physicsWorld.contactDelegate = self
        
        // Bird
        
        bird = childNode(withName: "bird") as! SKSpriteNode //manuel olarak kusu eklersek koda bu sekilde olusturuyoruz
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        //Buraya yazilan fonksiyonlar devamli olarak kontrol edilir.
